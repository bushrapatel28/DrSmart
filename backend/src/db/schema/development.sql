...
VALUES 
    ...
    ('2024-09-26', '10:30:00', 'Virtual', 'Completed', 2, 4),
    ('2024-09-27', '14:00:00', 'In-Person', 'Cancelled', 3, 2),
    ('2024-09-28', '11:15:00', 'In-Person', 'Completed', 4, 4),
    ('2024-09-29', '08:00:00', 'Virtual', 'Pending', 5, 2),
    ('2024-10-10', '20:00:00', 'In-Person', 'Pending', 4, 4),
    ('2024-10-10', '10:00:00', 'Virtual', 'Pending', 2, 4),
    ('2024-10-10', '18:00:00', 'In-Person', 'Scheduled', 4, 4),
...
INSERT INTO availabilities (date, vacant, time_slot_id, doctor_id) VALUES
  ...
  ('2024-10-10', TRUE, 1, 1),
  ('2024-10-10', TRUE, 2, 1),
  ('2024-10-10', FALSE, 3, 1),
  ('2024-10-10', TRUE, 4, 1),
  ('2024-10-10', FALSE, 5, 1),
  ('2024-10-10', TRUE, 6, 1),
  ('2024-10-10', TRUE, 4, 2),
  ('2024-10-10', TRUE, 5, 2),
  ...
  ('2024-10-10', TRUE, 7, 2),
  ('2024-10-10', TRUE, 8, 2),
  ('2024-10-10', FALSE, 9, 2),
  ('2024-10-10', TRUE, 10, 2),
  ('2024-10-10', TRUE, 11, 3),
  ('2024-10-10', TRUE, 12, 3),
  ('2024-10-10', FALSE, 13, 3),
  ('2024-10-10', TRUE, 14, 3),
  ('2024-10-10', TRUE, 15, 3),
  ('2024-10-10', TRUE, 9, 4),
  ('2024-10-10', TRUE, 10, 5),
  ('2024-10-10', TRUE, 1, 6),
  ('2024-10-10', TRUE, 2, 6),
  ('2024-10-10', FALSE, 3, 6),
  ('2024-10-10', TRUE, 4, 7),
  ('2024-10-10', TRUE, 5, 7),
  ('2024-10-10', FALSE, 6, 7),
  ('2024-10-10', TRUE, 7, 8),
  ('2024-10-10', TRUE, 8, 8),
  ('2024-10-10', TRUE, 9, 8),
  ('2024-10-10', TRUE, 5, 9),
  ('2024-10-10', TRUE, 8, 9),
  ('2024-10-10', FALSE, 10, 9),
  ('2024-10-10', TRUE, 11, 9),
  ('2024-10-10', TRUE, 12, 9),
  ('2024-10-10', TRUE, 4, 10),
  ('2024-10-10', TRUE, 6, 10),
  ('2024-10-10', TRUE, 13, 10),
  ('2024-10-10', TRUE, 14, 10),
  ('2024-10-10', FALSE, 15, 10),
